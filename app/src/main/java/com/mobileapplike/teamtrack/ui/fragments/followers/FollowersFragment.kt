...
import com.mobileapplike.teamtrack.databinding.FollowersFragmentBinding
...
import com.mobileapplike.teamtrack.ui.fragments.mygroupforeman.MyGroupForemansViewModel
import com.mobileapplike.teamtrack.ui.fragments.mygroupforeman.ObservableAdapter
...
import kotlinx.android.synthetic.main.my_group_foremans_fragment.rvObservablesUsersList
import kotlinx.android.synthetic.main.my_group_foremans_fragment.swtrlsObservablesUsers
...
class FollowersFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val binding = FollowersFragmentBinding.bind(view)
        ...
        fabClose.setOnClickListener {
            ...
            builder.setMessage("Do you want to close your own group?")
            ...
            override fun onChildDraw(c: Canvas, recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder, dX: Float, dY: Float, actionState: Int, isCurrentlyActive: Boolean) {
                ...
                if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
                    ...
                    if (dX > 0) {
                        ...
                        icon =
                            TrackingUtility.drawableToBitmap(resources.getDrawable(R.drawable.ic_edit_black_24dp))
                        ...
                        c.drawRect(background, p)
                        icon =
                            TrackingUtility.drawableToBitmap(resources.getDrawable(R.drawable.ic_delete_black_24dp))
        ...
        with(alert) {
            ...
            setPositiveButton("Ok") { dialog, whichButton ->
                ...
                if (new_phone_number.isEmpty()) {
                    ...
                    view?.let {
                        Snackbar.make(viewFragment, "Phone number must be not empty!", 1000).show()
                    }
        ...
        editTextAge!!.addTextChangedListener(object : PhoneNumberFormattingTextWatcher() {
            override fun afterTextChanged(s: Editable?) {
                ...
                dialog.getButton(AlertDialog.BUTTON_POSITIVE)
                    .setEnabled(TrackingUtility.isValidPhoneNumber(s.toString()));
            }
        });
